        ...
        4208: (e, t, n) => {
            ...
            n(8897)("replace", 2, (function(e, t, n, m) {
                return [function replace(i, r) {
                    ...
                    for (var _, S = "", k = 0, b = 0; b < v.length; b++) {
                        y = v[b];
                        ...
                        C >= k && (S += h.slice(k, C) + I, k = C + w.length)
                    }
                    return S + h.slice(k)
                }];
        ...
        9236: (e, t, n) => {
            ...
            n(8897)("split", 2, (function(e, t, n, c) {
                ...
                return g = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(e, t) {
                    ...
                    for (var k = 0, b = 0, w = []; b < h.length;) {
                        _.lastIndex = m ? b : 0;
                        var C, x = l(_, m ? h : h.slice(b));
                        if (null === x || (C = d(o(_.lastIndex + (m ? 0 : b)), h.length)) === k) b = s(h, b, v);
                        else {
                            if (w.push(h.slice(k, b)), w.length === S) return w;
